...
<div class="archive-feed">
    <div class="archive-feed__container container container--jc-center">
        ...
        <header class="archive-feed__header col col--12">
            <?php if ( apply_filters( 'woocommerce_show_page_title', true ) ) : ?>
                <h1 class="archive-feed__title woocommerce-products-header__title page-title"><?php woocommerce_page_title(); ?></h1>
            <?php endif; ?>
        ...
        <div class="archive-feed__wrap col col--12">
            <aside class="col col--3 col--lg-3 col--md-12 col--sm-12 col--xs-12 archive-feed__sidebar" role="complementary" aria-label="Product filters">
                 ...
                 */
                get_template_part( 'parts/sidebar-shop' );
                ?>
            </aside>
