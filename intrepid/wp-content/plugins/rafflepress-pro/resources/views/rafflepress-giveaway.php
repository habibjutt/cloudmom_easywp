...
if ( empty( $giveaway ) ) {
	wp_die( __( 'No Giveaway Found', 'rafflepress-pro' ) );
}
...
?>
		...
		<?php $ajax_url = html_entity_decode( wp_nonce_url( admin_url( 'admin-ajax.php' ) . '?action=rafflepress_pro_giveaway_comment', 'rafflepress_pro_giveaway_comment' ) ); ?>
