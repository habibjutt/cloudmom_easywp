...
<?php $tools_ajax_url = html_entity_decode( wp_nonce_url( 'admin-ajax.php?action=rafflepress_pro_get_automation_tool_list', 'rafflepress_pro_get_automation_tool_list' ) ); ?>
