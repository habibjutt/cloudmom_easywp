...
function rafflepress_pro_create_menus() {
	...
	if ( RAFFLEPRESS_PRO_BUILD == 'lite') {
		add_submenu_page(
			...
			'<span id="rp-lite-admin-menu__upgrade">' . __( 'Get Pro', 'rafflepress-pro' ) . '</span>',
			'read',
...
if ( defined( 'DOING_AJAX' ) ) {
	...
	add_action( 'wp_ajax_rafflepress_pro_get_automation_tool_list', 'rafflepress_pro_get_automation_tool_list' );
	...
	add_action( 'wp_ajax_rafflepress_pro_install_automation', 'rafflepress_pro_install_automation' );
	add_action( 'wp_ajax_rafflepress_pro_activate_automation', 'rafflepress_pro_activate_automation' );
	add_action( 'wp_ajax_rafflepress_pro_deactivate_automation', 'rafflepress_pro_deactivate_automation' );
	...
	add_action( 'wp_ajax_rafflepress_pro_giveaway_comment', 'rafflepress_pro_giveaway_comment' );
	add_action( 'wp_ajax_nopriv_rafflepress_pro_giveaway_comment', 'rafflepress_pro_giveaway_comment' );
