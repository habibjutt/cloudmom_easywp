 ...
 */
function rafflepress_pro_fetch_inline_help_data() {
	return array(
		'category_articles' => rafflepress_pro_fetch_articles(),
	);
}

// Action 
add_action( 'rafflepress_pro_fetch_help_docs', 'rafflepress_pro_update_help_articles' );
 ...
 */
function rafflepress_pro_fetch_articles() {
	// Get cache file.
	...
	if ( empty( $articles ) ) {
		...
		// rafflepress_pro_update_help_articles() should be triggered by schedule.
		$articles = rafflepress_pro_update_help_articles();
	}
 ...
 */
function rafflepress_pro_update_help_articles() {
	// Fetch categories.
	$categories = rafflepress_pro_fetch_categories();
	$articles   = array();
	...
	if ( ! empty( $articles ) && is_array( $articles ) ) {
		...
		if ( true === rafflepress_pro_set_up_upload_dir( $path, $cache_file ) ) {
 ...
 */
function rafflepress_pro_set_up_upload_dir( $path, $cache_file ) {
	try {
 ...
 */
function rafflepress_pro_fetch_categories() {
	// Fetch categories.
