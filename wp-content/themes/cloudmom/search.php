...
<section class="archive-feed">
    <div class="archive-feed__container container container--jc-center">
        ...
        <header class="archive-feed__header col col--8 col--lg-10 col--md-10 col--sm-12 col--xs-12">
            <h1 class="archive-feed__title">Search Results</h1>

            <?php if ( have_posts() ){ ?>
                <p class="archive-feed__subtitle">Results for '<?= get_search_query(); ?>'</p>
            <?php } else { ?>
                <p class="archive-feed__subtitle">Sorry, nothing to display. Results for '<?= get_search_query(); ?>' were not found.</p>
            <?php } ?>
        </header>
